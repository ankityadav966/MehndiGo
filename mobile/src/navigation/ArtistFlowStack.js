...
export default function ArtistFlowStack({ route }) {
  ...
  if (__DEV__) console.log(`[ARTIST_APPROVAL_DEBUG] [ARTIST_NAV_DEBUG] mounting ArtistFlowStack -> initialRoute: ${initialRouteName} | verificationStatus: ${verificationStatus}`);
