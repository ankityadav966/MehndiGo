...
const content = `const db = require("../models");
...
fs.writeFileSync(path.join(__dirname, 'services', 'payment.services.js'), content, 'utf8');
console.log('Successfully generated payment.services.js');
