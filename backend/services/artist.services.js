...
class ArtistService {
  ...
  async updateArtistProfile(userId, data) {
    ...
    const allowedUpdates = {
      ...
      latitude: data.latitude !== undefined ? data.latitude : (data.lat !== undefined ? data.lat : artist.latitude),
      longitude: data.longitude !== undefined ? data.longitude : (data.lng !== undefined ? data.lng : artist.longitude),
