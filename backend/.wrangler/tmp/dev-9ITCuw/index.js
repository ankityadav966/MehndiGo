...
var handleHomeDashboard = /* @__PURE__ */ __name(async (c2) => {
  ...
  if (hasUserLocation) {
    ...
    locationFilter = `AND ap.latitude IS NOT NULL AND ap.longitude IS NOT NULL AND (${distanceCalc} <= MIN(35, COALESCE(ap.service_radius, 35)))`;
  }
...
var handleSearchArtists = /* @__PURE__ */ __name(async (c2) => {
  ...
  if (lat !== null && lng !== null) {
    ...
    whereClauses.push(`(${distanceCalc} <= MIN(?, COALESCE(ap.service_radius, 35)))`);
    params.push(radius);
  }
  if (query) {
...
// .wrangler/tmp/bundle-e09SEv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-e09SEv/middleware-loader.entry.ts
