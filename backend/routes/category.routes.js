...
router.post("/admin", authenticate, authorize("ADMIN"), CategoryController.adminCreateCategory);
router.put("/admin/:id", authenticate, authorize("ADMIN"), CategoryController.adminUpdateCategory);
